    ...
    <div>
      <div class="justify-center items-center">
        ...
        <div class="pt-20 flex flex-row">
          <!-- Basic Card -->
          <div class="w-72 p-6 bg-white text-center rounded-3xl pl-10 shadow-xl">
          ...
          <!-- StartUp Card -->
          <div
            class="w-80 p-6 bg-gray-900 text-center rounded-3xl text-white border-4 shadow-xl border-white transform scale-110"
          >
